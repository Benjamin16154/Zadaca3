...
vector<Radnik> unos() {
  ...
  bool poPlati = [](const Radnik& a, const Radnik& b) { return a.plata < b.plata;};
  bool poImenu = [](const Radnik& a, const Radnik& b) { return a.ime < b.ime; };
  bool poStarosti = [](const Radnik& a, const Radnik& b) {return a.godinaRodjenja < b.godinaRodjenja;};
